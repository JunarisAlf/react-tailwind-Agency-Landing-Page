export default function PortofolioItem({ img, text, css}) {
    return (
        <div className="relative mx-auto px-10 flex flex-col items-center justify-center min-w-[16rem] w-1/2 aspect-square rounded-[2.5rem] bg-white drop-shadow-spread border border-1 border-grey border-opacity-20 lg:min-w-[11rem]">
