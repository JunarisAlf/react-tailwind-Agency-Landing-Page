export default function ServiceItem({ icon, text, bgColor }) {
    ...
    return (
        <div className="mx-auto  px-10 lg:px-5 flex flex-col gap-4 items-center justify-center w-1/3 min-w-[15rem] aspect-square rounded-2xl bg-white drop-shadow-spread border border-1 border-grey border-opacity-20 lg:min-w-[9rem] lg:mx-0">
            <div
